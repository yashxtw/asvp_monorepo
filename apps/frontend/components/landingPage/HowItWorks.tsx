...
export default function HowItWorks() {
    return (
        <section id="how-it-works" className="py-28 relative text-[#171717]">
            <div className="max-w-7xl mx-auto px-6 md:px-20">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
                        <span className="text-zinc-600">How the</span> platform works
                    </h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {steps.map((step) => (
                        <div key={step.number} className={`${step.tone} rounded-2xl p-10 transition duration-300`}>
                            <div className="mb-6 text-6xl font-extrabold text-primary/20">{step.number}</div>
